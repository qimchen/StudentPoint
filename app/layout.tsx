        ...
        <header className="mb-8">
          <div className="glass-card mb-6">
            ...
            <nav className="flex gap-2 sm:gap-3 flex-wrap mt-4 pt-4 border-t border-gray-200">
              <a href="/" className="btn btn-primary flex-1 sm:flex-none text-center group">
              ...
              <a href="/rules" className="btn btn-outline flex-1 sm:flex-none text-center group">
                <svg className="w-4 h-4 mr-1.5 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                积分规则
              </a>
              <a href="/admin" className="btn btn-success flex-1 sm:flex-none text-center group">
                <svg className="w-4 h-4 mr-1.5 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
